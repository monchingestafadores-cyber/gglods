...
function getQuestionLogPrompt(question) {
  ...
  if (currentGame === 3) {
    return `Rewrite using ${question.figure}: ${question.literal}`
  }
...
function checkCreative() {
  ...
  recordCurrentRunAnswer(q, rawAnswer, q.figure, correct)
...
function showPopup(title, message) {
  document.getElementById("popupBox").classList.remove("mechanics-popup", "answers-popup")
...
function showInstructions() {
  ...
  popupBox.classList.remove("answers-popup")
